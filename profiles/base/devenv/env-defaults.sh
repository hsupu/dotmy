...
#         ;;
#     "Darwin")
#         . "$DOTMY/profiles/base/devenv/mac/env.sh"
#         ;;
#     *)
...
# java
[[ -z $JAVA_HOME ]] && JAVA_HOME="$HOME/.local/jdk"
if [[ -d $JAVA_HOME ]]; then
    export JAVA_HOME
    [[ -z $JAVA_HOME ]] && export CLASSPATH=".:${JAVA_HOME}/lib/dt.jar:${JAVA_HOME}/lib/tools.jar"
